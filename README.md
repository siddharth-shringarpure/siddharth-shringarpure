<samp>
  ...
  **Languages**: `Python` `Java` `C` `TypeScript` `SQL`
  <br/>
  **Technologies**: `FastAPI` `Spring Boot` `React` `Next.js` `Flask` `Postgres` `Elasticsearch` `Neo4j` `Docker`
